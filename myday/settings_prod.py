...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'sanataniaryan010@gmail.com')

# Configure logging to capture email errors
LOGGING = {
    'version': 1,
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'myday.log'),
            'formatter': 'verbose',
        },
    },
    'loggers': {
