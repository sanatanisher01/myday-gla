"""
Minimal settings for Render deployment.
This file contains the bare minimum settings needed to run the application on Render.
"""
...
ROOT_URLCONF = 'myday.urls_render'
